...
const DashboardManage = () => {
  ...
  }, [socket, user.companyId, fetchMoments]);
            ...
            <div className={classes.changeWarap}>
              <Paper elevation={0} className={classes.cardHeader}>
                <CardHeader
                  ...
                  title={(
                    <div>
                      <Typography component="div" className={classes.cardHeaderTitle}>
                        {group?.user?.name || "Pendentes"}
                      </Typography>
                      <Typography component="div" className={classes.cardHeaderSubtitle}>
  ...
  }, [tickets, classes, companyId, history, user.id, user.profile]);
            ...
            <div padding={2} className={classes.changeWarap}>
              <Paper elevation={0} className={classes.cardHeaderPending}>
                <CardHeader
                  ...
                  title={(
                    <div>
                      <div className={classes.pendingTitleRow}>
                        <Typography component="div" className={classes.cardHeaderTitle}>Pendentes</Typography>
