        ...
        <div className={classes.contentWrapper}>
          ...
          <Grid item xs={12} md={6}>
            <Paper elevation={0} className={classes.card}>
              ...
              <Box className={classes.row}>
                <Typography className={classes.rowLabel}>Status</Typography>
                <Typography className={classes.rowValue}>
                  {String(wuzapiData.status).toUpperCase()}
                </Typography>
              </Box>
              <Box className={classes.row}>
                <Typography className={classes.rowLabel}>URL</Typography>
                <Typography className={classes.rowValue}>{wuzapiData.baseUrl}</Typography>
              </Box>
              <Box className={classes.row}>
                <Typography className={classes.rowLabel}>Versão</Typography>
                <Typography className={classes.rowValue}>
                  {wuzapiData.details?.version || "-"}
                </Typography>
              </Box>
              <Box className={classes.row}>
                <Typography className={classes.rowLabel}>Uptime</Typography>
                <Typography className={classes.rowValue}>
                  {wuzapiData.details?.uptime || "-"}
                </Typography>
              </Box>
              <Box className={classes.row}>
                <Typography className={classes.rowLabel}>Conexões ativas</Typography>
                <Typography className={classes.rowValue}>
                  {wuzapiData.details?.activeConnections ?? "-"}
                </Typography>
              </Box>
              <Box className={classes.row}>
                <Typography className={classes.rowLabel}>Usuários totais</Typography>
                <Typography className={classes.rowValue}>
                  {wuzapiData.details?.totalUsers ?? "-"}
                </Typography>
              </Box>
              <Box className={classes.row}>
                <Typography className={classes.rowLabel}>Usuários conectados</Typography>
                <Typography className={classes.rowValue}>
                  {wuzapiData.details?.connectedUsers ?? "-"}
                </Typography>
              </Box>
              <Box className={classes.row}>
                <Typography className={classes.rowLabel}>Usuários logados</Typography>
                <Typography className={classes.rowValue}>
                  {wuzapiData.details?.loggedInUsers ?? "-"}
                </Typography>
              </Box>
              {wuzapiData.details?.message ? (
                <Box className={classes.row}>
                  <Typography className={classes.rowLabel}>Mensagem</Typography>
                  <Typography className={classes.rowValue}>
                    {wuzapiData.details.message}
                  </Typography>
                </Box>
