...
  const normalizedContent = extractMessageContent(msg.message as any) || msg.message;
  const msgType = getContentType(normalizedContent as any) || getContentType(msg.message as any);
...
const flowbuilderIntegration = async (
  ...
  */
  ...
  if (ticket.flowWebhook) {
    ...
    // Mantém o lock até o TTL expirar para evitar disparo duplicado do
    // menu inicial quando o contato envia mensagens em sequência.
  }
};
