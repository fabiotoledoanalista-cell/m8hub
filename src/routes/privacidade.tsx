        ...
        <div className="mt-10 space-y-8 leading-relaxed text-slate-700">
          ...
          <section>
            ...
            <ul className="mt-2 list-disc pl-6 space-y-1">
              ...
              <li><strong>Cobrança:</strong> processada por plataformas parceiras (Kiwify / Cakto / Perfectpay) — não armazenamos dados de cartão.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc pl-6 space-y-1">
              <li>
                <strong>Plataformas de pagamento parceiras</strong> (Kiwify, Cakto, Perfectpay) — processam
                pagamentos e assinaturas conforme suas próprias políticas de privacidade.
              </li>
