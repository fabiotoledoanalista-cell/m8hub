        ...
        <aside className="hidden lg:flex flex-col justify-between p-10 xl:p-14 border-r border-[color:var(--hairline)] bg-[linear-gradient(160deg,rgba(22,163,74,.10),rgba(34,211,238,.04)_55%,transparent)]">
          ...
          <div className="space-y-8 max-w-lg">
            ...
            <h1 className="font-display text-4xl xl:text-5xl font-extrabold leading-[1.05] tracking-tight">
              CRM com <span className="text-gradient-brand">WhatsApp nativo</span>,<br />
              agente IA e pipeline<br />
              para PMEs brasileiras.
            </h1>

            <p className="text-[15px] text-muted-foreground leading-relaxed">
              Conecte seu WhatsApp, treine o agente em uma tela e organize seus leads em um kanban arrastável — tudo em um só lugar.
            </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {needsPassword && (
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <Input id="pwd" type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} autoFocus required className="h-11 pr-10" />
                        <button
                          type="button"
