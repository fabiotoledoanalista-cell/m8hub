      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mt-10 space-y-8 leading-relaxed text-slate-700">
          ...
          <section>
            ...
            <p className="mt-2">
              Os reembolsos são processados pela plataforma de pagamento utilizada na sua compra
              (Kiwify, Cakto ou Perfectpay). Para solicitar:
            </p>
            <ol className="mt-2 list-decimal pl-6 space-y-1">
              <li>Acesse a plataforma onde realizou a compra e localize seu pedido pelo e-mail.</li>
              <li>Solicite o reembolso diretamente pelo portal da plataforma.</li>
