      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mt-10 space-y-8 leading-relaxed text-slate-700">
          ...
          <section>
            ...
            <p className="mt-2">
              Os pagamentos são processados por plataformas parceiras (Kiwify, Cakto ou Perfectpay),
              conforme o plano escolhido. O atendimento a questões de cobrança e estornos é realizado
              diretamente pela plataforma utilizada na compra ou pelo nosso suporte.
            </p>
            <p className="mt-2">
              ...
              pela plataforma de pagamento ou entrando em contato com nosso suporte.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Dúvidas sobre estes Termos ou cobrança: entre em contato pelos canais do Serviço.
            </p>
          </section>
        </div>
      </div>
